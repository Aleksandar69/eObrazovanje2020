...
public class PredispitneObavezePolaganjeDto {
	...
	public PredispitneObavezePolaganjeDto() {

	}

	public PredispitneObavezePolaganjeDto(Long id, Date datum, float osvojeniBodovi, Long student, Long sablon,
			boolean polozio, Long predmet) {
		super();
		this.id = id;
		this.datum = datum;
