...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/supportportal/users/";
    public static final String DIRECTORY_CREATED = "Created directory for: ";
    public static final String DEFAULT_USER_IMAGE_PATH = "/users/image/profile/";
    public static final String DEFAULT_USER_FILE_PATH = "/users/documents/";
    ...
    public static final String TEMP_IMAGE = "../../assets/student.png";

    
    public static final String USER_DOCUMENT_PATH= "/studenti/documents/";
}
